        ...
        <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
            ...
            <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
                <div className='flex items-center gap-3'>
                    <Sparkles className='w-6 text-[#00DA43]' />
                ...
                <button className='flex w-full justify-center items-center gap-2 bg-gradient-to-r from-[#00DA43] to-[#009BB3] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
                    {
            ...
            <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]'>
                <div className='flex items-center gap-3'>
                    <FileText className='w-5 h-5 text-[#00DA43]' />
                    ...
                    !content ? (
                        <div className='flex flex-1 justify-center items-center'>
                            <div className='flex flex-col text-sm items-center gap-5 text-gray-400'>
                                ...
                                <p>Upload a Resume and click <span className='text-gray-700'>Review Resume</span> to get start</p>
                            </div>
                        </div>
                    ) : (
