...
import { Eraser, FileText, Hash, House, Image, LogOut, Scissors, SquarePen, User2 } from 'lucide-react';
...
const navItems = [
    ...
    { to: "/ai/community", label: "Community", Icon: User2 },
]
                ...
                <div className='px-6 mt-5 text-sm text-gray-600 font-medium'>
                    {
                        navItems.map(({ to, label, Icon }) => (
                            <NavLink key={to} to={to} end={to === '/ai'} onClick={() => setSidebar(false)} className={({ isActive }) => `px-3.5
